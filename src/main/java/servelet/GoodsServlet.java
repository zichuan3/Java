...
public class GoodsServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("findall".equals(p)) {
            ...
            doqury(request, response);
        }
    }

    private void doqury(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Goods> list = goodsDAO.query(goodsname, bottom, top, page, size);
        Map map = new HashMap();
        map.put("list", list);
        map.put("page", page);
        map.put("size", size);
